...
function MovieItem({ name, pic }: MovieItemProps) {
  ...
  return (
    <div
      className="flex-1 relative rounded-[5px] 
    ...
    >
      ...
      ></div>
      <div className="flex items-end absolute inset-0 p-2 pl-3 z-50">
        <div
          className="whitespace-nowrap overflow-hidden text-ellipsis text-[#fff]"
